...
final List<Education> educationList = [
  Education(
    description:
        "I have Done BS-CS(Becholer of Science in Computer science) from a well known University of Gujrat.",
    linkName: "www.Uog.com",
    period: "2016 - 2020",
  ),
  Education(
    description:
        "I have done I.C.S from Superior College Pasrur Best in the Area with Computer science as a major subject",
    linkName: "www.superiorcolleges.com",
    period: "2013 - 2015",
  ),
  // Education(
  //   description:
